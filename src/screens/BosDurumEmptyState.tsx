...
export function BosDurumEmptyState({ onAdd }: BosDurumEmptyStateProps) {
  return (
    <>
      {/* TopNavBar (Shared Component) */}
      <header className="bg-surface border-b border-outline-variant font-body text-sm antialiased docked full-width top-0 w-full fixed z-50">
      ...
      <main className="pt-24 pb-32 md:pb-24 px-margin max-w-3xl mx-auto min-h-screen flex flex-col">
        <HabitForm onAdd={onAdd} variant="compact" />
